    ...
    <div>
      ...
      <div className="flex flex-col gap-2 py-6 border-b">
        ...
        <p className="text-sm text-gray-500 mb-2">
          Access the Knowledge Base to find articles, guides, and frequently
          asked questions to help resolve issues.
        </p>
        <a
          href="https://help.school.com"
          target="_blank"
      ...
      <div className="flex flex-col items-start gap-2 py-6 border-b">
        ...
        <p className="text-sm text-gray-500 mb-2">
          If you cannot find the answer to your issue, you can submit a support
        ...
        {supportTicketSubmitted && (
          <p className="mt-2 text-xs text-gray-500">
            Your support ticket has been successfully submitted. Our team will
      ...
      <div className="flex flex-col gap-2 py-6 border-b">
        ...
        <p className="text-sm text-gray-500 mb-2">
          If you&#39;re unable to resolve your issue, you can contact IT support
